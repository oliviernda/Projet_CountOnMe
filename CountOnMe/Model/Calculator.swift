...
protocol CalculatorHandler : class {
...
final class Calculator {
    ...
    weak var calculatorHandlerDelegate: CalculatorHandler?
    ...
    private var expressionContainsDivisionByZero: Bool {
